#
# Be sure to run `pod lib lint ZCMenuControl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'ZCMenuControl'
  s.version          = '0.1.1'
  s.summary          = 'A short description of ZCMenuControl.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'ZCMenuControl' => ['ZCMenuControl/Assets/*.png']
  # }
